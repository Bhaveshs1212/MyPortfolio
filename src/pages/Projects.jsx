...
function Projects() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0C] text-[#F2F2F2]">
      {/* Breadcrumb */}
      <div className="max-w-6xl mx-auto pt-8 md:pt-12 pb-4 md:pb-6 px-4 md:px-8">
      ...
      {/* Projects List */}
      <div className="max-w-6xl mx-auto px-4 md:px-8 pb-16 md:pb-16 space-y-6 md:space-y-8">
